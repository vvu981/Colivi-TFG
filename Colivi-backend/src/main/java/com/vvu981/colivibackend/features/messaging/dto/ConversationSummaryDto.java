...
public record ConversationSummaryDto(
    ...
    public static ConversationSummaryDto fromEntity(Conversation conversation, UUID currentUserId, boolean isReported) {
        ...
        if (booking != null) {
            boolean isRejected = booking
                    .getStatus() == com.vvu981.colivibackend.features.bookingRequests.domain.RequestStatus.REJECTED;
            boolean isCancelledWithoutDeposit = booking
                    .getStatus() == com.vvu981.colivibackend.features.bookingRequests.domain.RequestStatus.CANCELLED
                    && booking.getTransactionId() == null;
            boolean isExpired = booking
                    .getStatus() == com.vvu981.colivibackend.features.bookingRequests.domain.RequestStatus.EXPIRED;
        ...
        if (listing != null && (listing.getBannedAt() != null || listing.getDeletedAt() != null)) {
            ...
            if (booking
                    .getStatus() == com.vvu981.colivibackend.features.bookingRequests.domain.RequestStatus.CONFIRMED) {
        ...
        if (listing.getAccommodation() != null && listing.getAccommodation().getImages() != null
                && !listing.getAccommodation().getImages().isEmpty()) {
