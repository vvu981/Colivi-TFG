    ...
    <footer className="bg-surface-container-lowest border-t border-outline-variant font-label-sm text-label-sm w-full pt-6 pb-24 md:pb-6 px-4 sm:px-6 md:px-margin-desktop flex flex-col md:flex-row justify-between items-center gap-4">
      ...
      <div className="flex flex-wrap justify-center md:justify-end gap-4 items-center">
        ...
        <button
          ...
          className="text-on-surface-variant hover:text-primary underline transition-all focus:ring-2 focus:ring-primary cursor-pointer bg-transparent border-none p-0 font-label-sm text-label-sm"
        >
          Cookie Settings
        </button>
