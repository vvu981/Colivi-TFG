...
describe('usePublicProfile', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(authContext.useAuth).mockReturnValue({
      ...
      isLoading: false,
      user: { id: 'other-user-999', email: 'other@test.com', firstName: 'Other', lastName1: 'User', lastName2: 'Test', nickname: 'other', role: 'USER', phone: null, profilePicUrl: null, createdAt: '' },
      token: 'jwt-token',
      login: vi.fn(),
  ...
  it('detecta correctamente si el perfil consultado es el propio', async () => {
    vi.mocked(authContext.useAuth).mockReturnValue({
      isAuthenticated: true,
      isLoading: false,
      user: { id: 'user-uuid-123', email: 'carlos@test.com', firstName: 'Carlos', lastName1: 'López', lastName2: 'Ruiz', nickname: 'carlos_host', role: 'USER', phone: null, profilePicUrl: null, createdAt: '' },
      token: 'jwt-token',
      login: vi.fn(),
      loginWithGoogle: vi.fn(),
      logout: vi.fn(),
