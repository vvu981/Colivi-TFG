...
/**
 * Modal to report a user profile for violations (Harassment, Fraud, Spam, Inappropriate content, etc.).
...
export const ReportUserModal: React.FC<ReportUserModalProps> = ({
  ...
  const displayName = userName || (userNickname ? `@${userNickname}` : 'este usuario');
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3 border-b border-slate-100 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="report-user-modal-title" className="text-lg font-bold text-on-surface">
                Denunciar usuario
              </h2>
              <p className="text-xs text-[#565e74] mt-0.5">
                Ayúdanos a mantener la comunidad de Colivi segura y de confianza
              </p>
            </div>
          </div>
        ...
        {isSubmitted ? (
          <div className="flex flex-col items-center justify-center py-8 px-4 text-center gap-4">
            ...
            <div className="flex flex-col gap-1.5 max-w-sm">
              ...
              <p className="text-xs text-[#565e74] leading-relaxed">
                Gracias por proteger nuestra comunidad. El equipo de moderación revisará la actividad de {displayName} según nuestras políticas de seguridad y convivencia.
              </p>
            </div>
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="p-3 bg-[#f8f9ff] rounded-2xl border border-slate-100 flex items-center gap-2.5">
              <UserX size={16} className="text-[#9f3c16] flex-shrink-0" />
              <span className="text-xs text-[#565e74] font-medium truncate">
                Usuario a denunciar: <strong className="text-[#0b1c30]">{displayName}</strong>
              </span>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                placeholder="Aporta contexto relevante sobre mensajes, conductas o incidentes para ayudar al equipo de moderación..."
